...
<head>
    ...
    <style>
        :root {
            ...
            --card-bg: #2d2d2d;
            --border-color: #444;
            --table-border-color: #cccc99; /* New light yellow for table borders */
            --code-bg: #282c34;
        ...
        .interactive-panel {
            flex: 1 1 30%; /* Initial width, allows growing/shrinking */
            min-width: 400px;
            height: 100vh;
            padding: 20px;
            box-sizing: border-box;
        ...
        .explanation-content-area table {
            ...
            border: 1px solid var(--table-border-color); /* Use new color */
            border-radius: 4px;
            overflow: hidden;
        }
        .explanation-content-area th, .explanation-content-area td {
            border-bottom: 1px solid var(--table-border-color); /* Use new color */
            border-right: 1px solid var(--table-border-color); /* Use new color */
            padding: 8px 10px;
            text-align: left;
            vertical-align: top;
        }
...
<body>
    <div class="container">
        <main class="tutorial-content" id="left-panel">
            ...
            <p>本頁面提供 C 語言第四章的互動練習題。請仔��分析題目，並選擇您認為正確的答案。點擊選項後，將會在<b>右側互動區塊</b>顯示該題的詳細解說。</p>
...
while(n!=0){
  ...
  n=n/10;
                    ...
                    <div class="explanation">
                        ...
                        <table>
                            <thead>
                                <tr><th>迴圈開始�� n</th><th>迴圈開始前 sum</th><th>條件 (n != 0)</th><th>條件結果</th><th>n % 10</th><th>sum = sum + (n % 10)</th><th>n = n / 10</th></tr>
                            </thead>
                            <tbody>
