...
<head>
    ...
    <title>C 語言 第四章 Part 2: 陣列與指標進階 (詳解版)</title>
    ...
    <style>
        ...
        .explanation-content-inner ul, .explanation-content-inner ol {
            padding-left: 20px;
            margin-bottom: 10px;
        }
        .explanation-content-inner ul li::marker {
            color: var(--primary-color);
        }
        .explanation-content-inner table {
            width: 100%;
        ...
        .explanation-content-inner th, .explanation-content-inner td {
            border: 1px solid var(--border-color);
            padding: 8px 10px;
            text-align: left;
            vertical-align: top;
        }
        .explanation-content-inner th {
            background-color: var(--primary-color);
            color: white;
            font-weight: bold;
        }
        .explanation-content-inner td code {
        ...
        .explanation-content-inner .code-block-within-explanation pre {
             background-color: var(--code-bg);
        }
...
<body>
    <div class="container">
        <main class="tutorial-content">
            ...
            <p>本頁面為 C/C++ 語言第四章練習題的第二部分 (第 21-44 題)，著重於陣列、指標的進階操作與綜合應用。請仔細分析每個題目，點擊選項後，右側將會顯示該題的詳細解說。</p>
            ...
            <div class="quiz-section">
                ...
                <div id="q33" class="quiz-card">
                    ...
                    <div class="quiz-options" data-correct="D">
                        ...
                        <div class="option" data-option="B">(B) 指標可以進行++或--運���</div>
        ...
        Y[i][j]=(i+1)*(j+1);
                    ...
                    <div class="explanation">
                        ...
                        <ul>
                            ...
                            <li><b>(C) Y[2][3]:</b> 這是陣列索引越界，因為 <code>j</code> 的最大索引��� 2 (對於 <code>Y[i][3]</code>)。如果能執行，其值會是 <code>(2+1)*(3+1) = 3*4 = 12</code>，但這是不合法的存取。</li>
                            <li><b>(D) Y[1][1]:</b>
                    ...
                    <div class="explanation">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr><td>2</td><td>64</td><td>64&lt;60 (F)</td><td>-</td><td>64&lt;60 (F)</td><td>-</td><td>1</td><td>2</td></tr>
        ...
        <aside class="interactive-panel">
            <div class="explanation-panel">
                ...
                <div id="explanation-content">
                    <div class="placeholder">請先在左側選擇一個題目並回答，這裡將會顯示該題的詳細解說。</div>
                </div>
            </div>
        </aside>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.quiz-options').forEach(optionsContainer => {
                optionsContainer.addEventListener('click', function handleOptionClick(e) {
                    if (e.target.classList.contains('option') && !this.classList.contains('answered')) {
                        ...
                        const explanationSource = quizCard.querySelector('.explanation');
                        const questionTitle = quizCard.querySelector('h3').textContent;

                        if (explanationSource) {
                            const explanationHtml = `<div class="explanation-content-inner"><h3>${questionTitle}</h3>${explanationSource.innerHTML}</div>`;
            ...
            const mouseDownHandler = function (e) {
                ...
                const mouseMoveHandler = function (e_move) {
                    ...
                    if (newLeftWidth > minLeftWidth && (containerWidth - newLeftWidth) > minRightWidth) {
                       ...
                       // No need to set right side width if it uses flex-grow
                    }
                };
