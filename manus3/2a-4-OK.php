                    ...
                    if (quizCard) {
                        const explanationContent = quizCard.dataset.explanation;
                                const explanationContainer = `
                                    <div class="sandbox-container">
                                        <h3>詳細解說</h3>
                                <div class="explanation-content" style="padding: 15px; height: calc(100% - 60px); overflow-y: auto; background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 4px; font-family: 'Noto Sans TC', sans-serif; color: var(--text-color);">
                                    ${explanationContent}
                                </div>
                            </div>
                        `;
