...
<head>
    ...
    <title>C 語言 第四章 詳細追蹤練習 (2/3) - 更新版</title>
    ...
    <style>
        ...
        /* Hide original explanation block */
        .explanation {
            display: none;
        }
        .next-btn-container {
...
<body>
    <div class="container">
        <main class="tutorial-content" id="left-panel">
            ...
            <p>本頁面提供 C 語言第四章的互動練習題。請仔細分析題目，並選擇您認為正確的答案。點擊選項後，將會在<b>右側互動區塊</b>顯示該題的詳細解說。您可以利用右側的程式碼沙箱，執行或修改範例程式碼，以加強學習效果。</p>
            <div class="quiz-section">
                <h2>第四章 互動練習題 - 詳細追蹤版 (題目 16-30)</h2>
                <p>請挑戰下面的題目，檢驗您的學習成果！點擊選項後，詳解將顯示於右側面板。</p>
                <!-- QUIZ CARDS START (Content is the same as original, only the hidden .explanation div is used by JS) -->
...
while(i&lt;800) {i=i*i;}</code></pre>
                ...
                <!-- ... other quiz cards are omitted for brevity but should be included in the actual file ... -->
        ...
        quizOptions.forEach(optionsContainer => {
            ...
            options.forEach(option => {
                option.addEventListener('click', function () {
                    ...
                    // Find the hidden explanation div within the same quiz card
